                        ...
                        <Fragment><br/>
                           <Row className="p-2">
                            <Breadcrumb className="shadow-sm w-100 bg-white mt-5">
                              ...
                              <Breadcrumb.Item><Link to={"/ProductListBySubcategory/"+this.props.category+"/"+this.props.subcategory}>ListBySubcategory</Link></Breadcrumb.Item>
                            </Breadcrumb>
                           </Row>
                            <Container className="text-center TopSection animated slideInDown" fluid={true}>
                                <h4 className="section-title text-success"><span className="text-danger">SUBCATEGORY</span> <span className="text-success">WISE</span> <span className="text-primary">PRODUCTS</span></h4>
                                <h4 className="section-title text-muted">CATEGORY : <span className="text-danger">{this.props.category}</span> </h4>
                                <h4 className="section-title text-muted">SUBCATEGORY : <span className="text-danger">{this.props.subcategory}</span> </h4>
                                  <Row>
                ...
                return (
                        <Fragment><br/>
                            ...
                            <Container className="text-center TopSection" fluid={true}>
                                <h4 className="section-title text-success"><span className="text-danger">SUBCATEGORY</span> <span className="text-success">WISE</span> <span className="text-primary">PRODUCTS</span></h4>
                                <h4 className="section-title text-muted">CATEGORY : <span className="text-danger">{this.props.category}</span></h4>
                                <h4 className="section-title text-muted">SUBCATEGORY : <span className="text-danger">{this.props.subcategory}</span></h4><br/>
                                  <Row>
                                    {MyView}
                                  </Row>
                           </Container>
